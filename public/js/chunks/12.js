  ...
  methods: {
    ...
    goItem: function goItem(item) {
      ...
      this.$http.post('sys/auth/checker', item).then(function (response) {
        ...
        if (u) {
          _this.$go({ name: 'auth.password', params: { id: u.id } });
        }
      }).catch(function (err) {
        _this.sending = false;
        _this.$toast(err);
...
/***/ "./node_modules/vue-loader/lib/template-compiler/index.js?{\"id\":\"data-v-8da7a600\",\"hasScoped\":false,\"buble\":{\"transforms\":{}}}!./node_modules/vue-loader/lib/selector.js?type=template&index=0&bustCache!./resources/assets/js/vendor/gmf-sys/Pages/Auth/Chooser.vue":
/***/ (function(module, exports, __webpack_require__) {
      ...
      _vm.mainDatas && _vm.mainDatas.length
        ? [
            ...
            _c(
              "md-card-content",
              [
                _c("md-button", { attrs: { to: { name: "auth.remove" } } }, [
                  _vm._v("\n        移除账号\n      ")
                ])
              ],
              1
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-8da7a600", module.exports)
  }
}
...
/* template */
var __vue_template__ = __webpack_require__("./node_modules/vue-loader/lib/template-compiler/index.js?{\"id\":\"data-v-8da7a600\",\"hasScoped\":false,\"buble\":{\"transforms\":{}}}!./node_modules/vue-loader/lib/selector.js?type=template&index=0&bustCache!./resources/assets/js/vendor/gmf-sys/Pages/Auth/Chooser.vue")
/* template functional */
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-8da7a600", Component.options)
  } else {
    hotAPI.reload("data-v-8da7a600", Component.options)
' + '  }
